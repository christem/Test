...
public class Base64Util2 {
	...
	// -- 3 bytes for every 4 valid Base64Util2 chars
	// -- plus 2 bytes if there are 3 extra Base64Util2 chars,
    ...
    //
    // lookup table for converting Base64Util2 characters to value in range
    // 0..63
    //
