...
public class RedisHashes {
	...
	//
	System.out.println(jedis.hsetnx("hashes:test1", "1", "test1"));
	System.out.println(jedis.hsetnx("hashes:test1", "2", "test2"));
	System.out.println(jedis.hsetnx("hashes:test1", "3", "test3"));
	System.out.println(jedis.hsetnx("hashes:test1", "3", "10"));

	// System.out.println(jedis.hdel("hashes:test1", "3"));
