package demo.base.c17Socket.s4.LanChat;
...
/**
 * Description:该类用于网络通信，它包含了MulticastSocket实例和 DatagramSocket实例,分别实现广播和私聊功能
 *
 * <br/>
...
public class ComUtil {
	...
	class ReadSingle extends Thread {
		...
		private DatagramPacket singlePacket = new DatagramPacket(singleBuff,
				singleBuff.length);
			...
			while (true) {
				...
				// 捕捉异常
					...
					JOptionPane.showMessageDialog(null,
							"接收信息异常，请确认30001端口空闲，且网络连接正常！", "网络异常",
