...
public class ExtendedObjectPoolFactory {
	...
	// 该方法根据指定文件来初始化对象池，
	// 它会根据配置文件来创建对象
	public void initPool() throws InstantiationException, IllegalAccessException,
	...
	public void initProperty() throws InvocationTargetException, IllegalAccessException,
