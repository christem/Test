...
public class AttributeViewTest {
	...
	public static void main(String[] args) throws Exception {
		// 获取将要操作的文件
		Path testPath = Paths
				.get("E:/Code/MyGitProject/Test/src/main/java/demo/base/c15IO/s10/AttributeViewTest.java");
		...
		System.out.println("创建时间："
				+ new Date(basicAttribs.creationTime().toMillis()));
		System.out.println("最后访问时间："
				+ new Date(basicAttribs.lastAccessTime().toMillis()));
		System.out.println("最后修改时间："
				+ new Date(basicAttribs.lastModifiedTime().toMillis()));
